...
ewd_header([
    'title'  => 'Browse worlds',
    'active' => 'browse',
    'description' => 'High-fidelity worlds for Edusim HiFi, the Babylon.js edition — open one straight in the app, or download it and make it your own.',
]);

ewd_hero(
    '🌍 Shared worlds',
    'Worlds other people built',
    'Every world here is a high-fidelity world for Edusim HiFi, the Babylon.js edition. Look round the '
    . 'screenshots, read what they were going for, then <strong>download the world file '
    . 'and open it in Edusim HiFi</strong> — it lands in your copy exactly as they left it, and '
    ...
    . '<a class="btn btn-ghost" href="' . e(EWD_APP_URL) . '" target="_blank" rel="noopener noreferrer">Open Edusim HiFi</a>'
);
?>
