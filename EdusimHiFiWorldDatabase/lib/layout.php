...
{
    $title    = (string)($opts['title'] ?? 'HiFi Worlds Database');
    $desc     = (string)($opts['description'] ?? 'High-fidelity worlds for Edusim HiFi, shared by the people who made them.');
...
<title><?= e($title) ?> — Edusim HiFi Worlds Database</title>
<meta name="description" content="<?= e($desc) ?>" />
<?php if ($canonical !== ''): ?>
<link rel="canonical" href="<?= e($canonical) ?>" />
<?php endif; ?>
<meta property="og:site_name" content="Edusim HiFi Worlds Database" />
  ...
  <div class="wrap">
    ...
    <a class="brand" href="index.php">
      <span class="brand-word">Edusim
        <small>HiFi Worlds Database</small>
      </span>
    </a>
    ...
    <a class="btn btn-primary nav-cta" href="<?= e(EWD_APP_URL) ?>" target="_blank" rel="noopener noreferrer"><span class="nav-cta-label">▶ Launch<span class="nav-cta-word"> Edusim HiFi</span></span></a>
  ...
  <div class="wrap">
    <div class="footer-row">
      <div class="footer-brand">
        <span class="footer-word">Edusim</span> HiFi
      </div>
      <ul class="footer-links">
        <li><a href="index.php">Browse worlds</a></li>
        <li><a href="share.php">Share your world</a></li>
        <li><a href="<?= e(EWD_APP_URL) ?>" target="_blank" rel="noopener noreferrer">Open Edusim HiFi</a></li>
        <li><a href="<?= e(EWD_GUIDE_URL) ?>" target="_blank" rel="noopener noreferrer">Hands-On Guide</a></li>
        <li><a href="<?= e(EWD_SITE_URL) ?>" target="_blank" rel="noopener noreferrer">Main site</a></li>
